        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="rounded-lg border border-base-300 bg-base-100 p-4">
            ...
            <p className="mt-1 text-sm text-base-content/60">
              Players get{' '}
              {difficulty === 'easy' ? 30 : difficulty === 'normal' ? 20 : 10}{' '}
              seconds per frame to lock in their guess.
            </p>
          </div>
          <div className="rounded-lg border border-base-300 bg-base-100 p-4">
            <p className="text-sm uppercase tracking-wide text-base-content/60">
          ...
          <div className="rounded-lg border border-base-300 bg-base-100 p-4">
            ...
            <p className="text-lg font-semibold text-base-content">
              {currentFrameDisplay}/{totalFrames}
            </p>
            <p className="mt-1 text-sm text-base-content/60">
              Timer left: {timerDisplay}
            </p>
          </div>
        </div>
        {framesMissing > 0 && (
          <div className="alert alert-warning">
            ...
            <span>
              Add {framesMissing} more frame{framesMissing === 1 ? '' : 's'} to
